...
public class Updater extends SwingWorker<Void, Integer>{
    ...
    public String applink = "https://www.dropbox.com/s/3q5jr63k3m1tfce/ScreenieUp.jar?dl=1";// at the end: "?dl=1" MUST BE 1 otherwise it will result in a corrupt file... go figure
